...
/**
 * 控制状态栏样式、设置颜色、半透明、透明等
 */
public class StatusBarUtil {

    @TargetApi(Build.VERSION_CODES.KITKAT)
    public static void setColorBar(Activity activity, @ColorInt int color, int alpha) {
    ...
    @TargetApi(Build.VERSION_CODES.KITKAT)
    public static void setColorBarForDrawer(Activity activity, @ColorInt int color, int alpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            Window window = activity.getWindow();
            ViewGroup decorView = (ViewGroup) window.getDecorView();
    ...
    @TargetApi(Build.VERSION_CODES.KITKAT)
    public static void setColorBarForDrawer(Activity activity, @ColorInt int color) {
